...
PERMIT_EXECUTION: this pass vets BY RUNNING each tool on the host — run it on a
sandboxed/disposable host. Functional-conformance only; run alongside ClawHub
verify / ClawScan, never instead.
"""
